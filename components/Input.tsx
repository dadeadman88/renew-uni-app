  ...
  return (
    <TextField
      ...
      fieldStyle={[
        styles.outline,
        {
          borderColor: isDarkMode ? theme.dark_color.borderColor : theme.color.borderColor,
          backgroundColor: isDarkMode ? theme.dark_color.grayBackground : theme.color.grayBackground,
          paddingHorizontal: "4%",
